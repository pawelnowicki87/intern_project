...
export class CreateUsers1760865063167 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post_assets" ("post_id" integer NOT NULL, "file_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_98bf2355b6e999152f8f89f1d07" PRIMARY KEY ("post_id", "file_id"))`);
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "title" character varying, "body" text, "user_id" integer NOT NULL, "status" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "follows" ("follower_id" integer NOT NULL, "followed_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b6aa74193794c7c5d09e7423c7f" PRIMARY KEY ("follower_id", "followed_id"))`);
        await queryRunner.query(`CREATE TABLE "message_assets" ("message_id" integer NOT NULL, "file_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4ba4c9c6764854c6873817d3438" PRIMARY KEY ("message_id", "file_id"))`);
        await queryRunner.query(`CREATE TABLE "chat_participants" ("chat_id" integer NOT NULL, "user_id" integer NOT NULL, "joined_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_36c99e4a017767179cc49d0ac74" PRIMARY KEY ("chat_id", "user_id"))`);
        await queryRunner.query(`CREATE TABLE "chats" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" SERIAL NOT NULL, "sender_id" integer NOT NULL, "receiver_id" integer NOT NULL, "chat_id" integer, "title" character varying, "body" text, "is_read" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "likes_posts" ADD CONSTRAINT "FK_5eca95fe513d96a0c7727ea4ad5" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "likes_posts" ADD CONSTRAINT "FK_ce551716fa81636c9befe526391" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "post_assets" ADD CONSTRAINT "FK_ae3495fdc7a04ae0a3ed29c0370" FOREIGN KEY ("post_id") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "post_assets" ADD CONSTRAINT "FK_c0439145e0f00318ff821d6b8d3" FOREIGN KEY ("file_id") REFERENCES "files"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "follows" ADD CONSTRAINT "FK_48e534a8c1b29ca3a81e8d112b7" FOREIGN KEY ("followed_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message_assets" ADD CONSTRAINT "FK_11ed3d5b2dfbc265705fff99938" FOREIGN KEY ("message_id") REFERENCES "messages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message_assets" ADD CONSTRAINT "FK_56033d9e3fee6f7712c0b06dee5" FOREIGN KEY ("file_id") REFERENCES "files"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "profile_to_profile_configurations" ADD CONSTRAINT "FK_0b913556f1b644a67dc48428609" FOREIGN KEY ("source_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "profile_to_profile_configurations" ADD CONSTRAINT "FK_efe2aa9fe124ab394d1bb540c7c" FOREIGN KEY ("target_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "profile_to_profile_configurations" DROP CONSTRAINT "FK_efe2aa9fe124ab394d1bb540c7c"`);
        await queryRunner.query(`ALTER TABLE "profile_to_profile_configurations" DROP CONSTRAINT "FK_0b913556f1b644a67dc48428609"`);
        ...
        await queryRunner.query(`ALTER TABLE "message_assets" DROP CONSTRAINT "FK_56033d9e3fee6f7712c0b06dee5"`);
        ...
        await queryRunner.query(`ALTER TABLE "post_assets" DROP CONSTRAINT "FK_c0439145e0f00318ff821d6b8d3"`);
        await queryRunner.query(`ALTER TABLE "post_assets" DROP CONSTRAINT "FK_ae3495fdc7a04ae0a3ed29c0370"`);
        await queryRunner.query(`ALTER TABLE "likes_posts" DROP CONSTRAINT "FK_ce551716fa81636c9befe526391"`);
        await queryRunner.query(`ALTER TABLE "likes_posts" DROP CONSTRAINT "FK_5eca95fe513d96a0c7727ea4ad5"`);
