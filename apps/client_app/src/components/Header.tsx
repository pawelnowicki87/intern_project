...
import { Send, Search, PlusSquare, Home, Compass, User, Settings, Moon, LogOut } from 'lucide-react';
  ...
  return (
    <header className="bg-white border-b border-gray-300 sticky top-0 z-10">
      <div className="max-w-[935px] mx-auto px-4 py-2 md:py-3 flex items-center justify-between">
        <Link href="/feed">
          <h1 className="text-2xl md:text-3xl font-serif italic cursor-pointer">Innogram</h1>
        </Link>
